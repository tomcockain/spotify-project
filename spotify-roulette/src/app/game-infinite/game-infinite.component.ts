...
@Component({
  selector: 'app-game-infinite',
  templateUrl: './game-infinite.component.html',
  styleUrls: ['./game-infinite.component.css'],
  animations: [
...
export class GameInfiniteComponent implements OnInit {
